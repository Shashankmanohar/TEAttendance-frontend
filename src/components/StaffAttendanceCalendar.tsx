...
export default function StaffAttendanceCalendar({ records, currentDate, setCurrentDate }: StaffAttendanceCalendarProps) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-xs font-black text-[#8424bd] uppercase tracking-widest mt-1">Attendance Overview</p>
        </div>
          ...
          return (
            <motion.div 
              ...
              className={cn(
                ...
                record ? "bg-white border-slate-100 shadow-sm" : ""
              )}
            >
              <div className="flex justify-between items-start">
                ...
                {record && (
                  <div className={cn(
                    ...
                    record.checkIn && record.checkOut ? "bg-emerald-500 shadow-sm shadow-emerald-100" : "bg-amber-400"
                  )} />
                )}
              </div>
                   ...
                   <div className="hidden md:flex flex-col gap-1">
                      ...
                      <div className="h-0.5 w-full bg-emerald-500/20 rounded-full overflow-hidden">
                        <motion.div 
                          ...
                          initial={{ width: 0 }}
                          animate={{ width: record.checkOut ? '100%' : '50%' }}
                        />
                      </div>
                   </div>
                ) : (
                  isOff && !isToday && <div className="h-1 w-4 bg-slate-200 rounded-full mx-auto" />
                )}
              </div>
            </motion.div>
          );
      ...
      <div className="flex flex-wrap gap-6 pt-6 border-t border-slate-50">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Full Day Work</span>
        </div>
        <div className="flex items-center gap-2">
